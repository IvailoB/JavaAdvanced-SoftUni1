...
int bombFounds = 0;
        for (int i = 0; i < commands.length; i++) {
            ...
            if (matrix[sapperRow][sapperCol] == 'B'){
                ...
                bombFounds++;
                if (bombCounter == bombFounds){
                    System.out.println("Congratulations! You found all bombs!");
                    return;
                }
            }else if (matrix[sapperRow][sapperCol] == 'e'){
                System.out.printf("END! %d bombs left on the field%n", bombCounter - bombFounds);
                return;
            }
        }
        System.out.printf("%d bombs left on the field. Sapper position: (%d,%d)",bombCounter - bombFounds,sapperRow,sapperCol);
